                                        ...
                                        ?>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <a a href="apaga_cliente.php?id=<?php echo $dados['id_cliente']; ?>" class="btn btn-danger" > <button class="btn btn-danger" onclick="myFunction()">Apagar</button></a>                
                                                   
                                                        <script>
                                                        function myFunction() {
                                                        alert("Apagar cliente?");
                                                        }
                                                        </script>                                    
                                                </div>
                                            </td>
